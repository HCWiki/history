...
11月6日，ee将NovelAI画的大部分图片剪辑成了卡点视频，分别是[eebot特辑](http://paperee.guru/eebot.mp4)（已失效）和[NovelAI特辑](https://paperee.guru/NovelAI.mp4)（已失效）。后来，Maggie和4n0n4me先后用Python写了脚本来批量爬取生成的图片（~~多为涩图~~）
